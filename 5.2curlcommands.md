...
ToDo: change "toolUrl" to your gdcc.github.io
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://schorcht-ioer.github.io/previewers/v1.3/MapShpPreview.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://schorcht-ioer.github.io/previewers/v1.3/MapRasterPreview.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
